...
/**
 * Test case for class \WX\WxLottery\Domain\Model\Ticket.
 *
 * @version $Id$
 ...
 */
class TicketTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new \WX\WxLottery\Domain\Model\Ticket();
	}
	 ...
	 * @test
	 */
	public function getChancesReturnsInitialValueForFloat() { 
		$this->assertSame(
			0.0,
			$this->fixture->getChances()
		);
	}
	 ...
	 * @test
	 */
	public function setChancesForFloatSetsChances() { 
		$this->fixture->setChances(3.14159265);
	 ...
	 * @test
	 */
	public function getMoneyBackReturnsInitialValueForOolean() { }

	/**
	 * @test
	 */
	public function setMoneyBackForOoleanSetsMoneyBack() { }
	
	/**
	 * @test
	 */
	public function getNrOfTicketsReturnsInitialValueForInteger() { 
		$this->assertSame(
			0,
			$this->fixture->getNrOfTickets()
		);
	}
	 ...
	 * @test
	 */
	public function setNrOfTicketsForIntegerSetsNrOfTickets() { 
		$this->fixture->setNrOfTickets(12);
